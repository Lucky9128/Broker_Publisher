...
int main(int argv,char *argc[])
{
	...
	{
		bzero(buf,1024);
		sprintf(buf,"11Advan3sds%d:Lucky",i);	
		kl++;
	...
	{
		bzero(buf,1024);
		sprintf(buf,"11Adsdh4h%d:Lucky2",i);	
		kl++;
		int k=send(sock,buf,strlen(buf),0);
		bzero(buf,1024);
		printf("waiting for rec...%d\n",kl);
	...
	// {
	// 	bzero(buf,1024);
	// 	sprintf(buf,"01Eyanshu:Advantage%d",i);
	// 	kl++;	
	// 	int k=send(sock,buf,strlen(buf),0);
	// 	bzero(buf,1024);
	// 	printf("waiting for rec...%d\n",kl);
	...
	// }
		...
		// bzero(buf,1024);
		// sprintf(buf,"04Eyanshu:Advantage0");	
		// kl++;
		// int k=send(sock,buf,strlen(buf),0);
		// printf("waiting for rec...%s\n",buf);
