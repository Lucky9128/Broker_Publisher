...
void main()
{
    struct Publisher * PublisherList =NULL;
    struct Topic * Topiclist =NULL;
    struct Subscriber * SubList =NULL;
    PublisherList = addPublisher(PublisherList,"Advantage","lucky");
    Topiclist = addTopic(Topiclist,"Advantage2","lucky");
    PublisherList = addPublisher(PublisherList,"Advantage2","lucky");
    Topiclist = addTopic(Topiclist,"Advantage2","lucky");
    PublisherList = addPublisher(PublisherList,"Advantage24","lucky");
    Topiclist = addTopic(Topiclist,"Advantage24","lucky");
    PublisherList = addPublisher(PublisherList,"Advantage3","lucky2");
    Topiclist = addTopic(Topiclist,"Advantage3","lucky2");
    PublisherList = addPublisher(PublisherList,"Advantage32","lucky");
    Topiclist = addTopic(Topiclist,"Advantage32","lucky");
    PublisherList = addPublisher(PublisherList,"Advantage32","lucky2");
    Topiclist = addTopic(Topiclist,"Advantage32","lucky2");
    // matchTopicPublisher(PublisherList,"Advantage32","lucky2");
    addMsg(Topiclist,"Hello brother","lucky2","Advantage32");
    addMsg(Topiclist,"Hello brother2","lucky","Advantage24");
    addMsg(Topiclist,"Hello brother3","lucky2","Advantage3");
    addMsg(Topiclist,"Hello brother4","lucky","Advantage32");
    addMsg(Topiclist,"Hello brother5","lucky","Advantage24");
    addMsg(Topiclist,"Hello brother6","lucky2","Advantage3");
    addMsg(Topiclist,"Hello brother7","lucky","Advantage32");
    int k=0;
    char ar[100];
    bzero(ar,100);
    SubList = addSbscr(SubList,Topiclist,"Advantage32","Eyanshu",&k,&ar[0]);
    SubList = addSbscr(SubList,Topiclist,"Advantage3","Eyanshu",&k,&ar[0]);
    SubList = addSbscr(SubList,Topiclist,"Advantage24","Eyanshu",&k,&ar[0]);
    SubList = addSbscr(SubList,Topiclist,"Advantage","Eyanshu3",&k,&ar[0]);
    SubList = addSbscr(SubList,Topiclist,"Advantage3","Eyanshu2",&k,&ar[0]);
    SubList = addSbscr(SubList,Topiclist,"Advantage25","Eyanshu2",&k,&ar[0]);
    printAllPublisher(PublisherList);
    printAllTopic(Topiclist);
    printAllSubscriber(SubList);
    printf("Printing data\n");
    printf("Getting data form eyanhsu :%s\n",GetMsg(Topiclist,SubList,"Advantage32","Eyanshu"));
    printf("Getting data form eyanhsu :%s\n",GetMsg(Topiclist,SubList,"Advantage32","Eyanshu"));
    printf("Getting data form eyanhsu :%s\n",GetMsg(Topiclist,SubList,"Advantage24","Eyanshu"));
    printf("Getting data form eyanhsu :%s\n",GetMsg(Topiclist,SubList,"Advantage32","Eyanshu"));
    printf("Getting data form eyanhsu :%s\n",GetMsg(Topiclist,SubList,"Advantage24","Eyanshu"));
    printf("Getting data form eyanhsu :%s\n",GetMsg(Topiclist,SubList,"Advantage32","Eyanshu"));
}